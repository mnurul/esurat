...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jan 2021 pada 16.20
...
(4, '3525100301770003', 'Zafran', 'Jakarta', '2021-01-03', 'jln bima', 'Islam', 'L', '', '', '', '', ''),
(5, '3525100301770004', 'admin', 'Jakarta', '2021-01-01', 'jln. bima terus 3', 'Islam', 'L', '', '', '', '', '');
...
--
ALTER TABLE `tb_surat_masuk_rt`
  MODIFY `id_surat_masuk` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `tb_warga`
  MODIFY `id_warga` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
